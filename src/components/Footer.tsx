...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Merchandising Manager", path: "/about" },
    { label: "Benefits of REACH Merchandising Manager", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    { label: "Presentations", path: "/presentations" },
    { label: "REACH Merchandising Manager Images", path: "/rmmimages" },
