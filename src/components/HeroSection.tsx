...
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* 🔒 Hidden SEO H1 – Not Visible on Website */}
      <h1 className="sr-only">
        REACH Merchandising Manager – Retail and Apparel Merchandising Software
      </h1>
        ...
        <div className="relative bg-white/70 backdrop-blur-md px-6 py-4 sm:px-10 sm:py-8 lg:px-16 lg:py-12 text-center max-w-[90vw] sm:max-w-xl rounded-xl">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <span className="text-[#b0004c]">REACH</span> Merchandising Manager!
            </h2>
          </div>
        </div>
      </div>
